...
export declare type WebhookUpdateData = Partial<Pick<Webhook, 'isAdHoc' | 'eventTypes' | 'condition' | 'ignoreSslErrors' | 'doNotRetry' | 'requestUrl' | 'payloadTemplate'>> & WebhookIdempotencyKey;
export interface WebhookStats {
    totalDispatches: number;
}
export declare type WebhookEventType = keyof typeof WEBHOOK_EVENT_TYPES;
export declare type WebhookCondition = WebhookAnyRunOfActorCondition | WebhookAnyRunOfActorTaskCondition | WebhookCertainRunCondition;
