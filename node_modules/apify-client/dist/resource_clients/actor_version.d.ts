...
export declare type ActorVersion = ActorVersionSourceCode | ActorVersionGitRepo | ActorVersionTarball | ActorVersionGitHubGist;
export declare type FinalActorVersion = ActorVersion & Required<Pick<ActorVersion, 'versionNumber' | 'buildTag'>>;
